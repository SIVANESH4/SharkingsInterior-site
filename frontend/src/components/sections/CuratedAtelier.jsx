...
const localAtelierServices = [
  {
    id: 'residential',
    label: 'RESIDENTIAL',
    tag: 'ATELIER RESIDENCE 1',
    chapter: '01',
    image: '/images/service-residential.png',
    concept: 'ORGANIC LIVING',
    title: 'SENSORY PRIVATE RESIDENCES',
    description: 'Masterfully structured living spaces utilizing raw charcoal plaster, brushed brass accents, and custom linen-wrapped wall panels.',
    features: [
      'Ergonomic Spatial Layout Design',
      'Tactile Charcoal Plaster Finishes',
      'Custom Recessed Uplighting',
      'Handpicked Natural Fabrics'
    ],
    cycle: '6-8 Weeks'
  },
  {
    id: 'modular',
    label: 'MODULAR',
    tag: 'ATELIER KITCHEN 2',
    chapter: '02',
    image: '/images/service-furniture.png',
    concept: 'DESIGN CONCEPTS',
    title: 'MODERN MODULAR KITCHENS',
    description: 'Bespoke European and contemporary smart kitchen systems featuring textured natural veneers, premium silent pull-outs, and robust German hardware.',
    features: [
      'Ergonomic Layout Architecture',
      'Tactile Veneer Finishes',
      'Brushed Gold Silent Fittings',
  ...
  },
  {
    id: 'commercial',
    label: 'COMMERCIAL',
    tag: 'ATELIER STUDIO 3',
    chapter: '03',
    image: '/images/service-commercial.png',
    concept: 'RETAIL AESTHETICS',
    title: 'CURATED RETAIL SHOWROOMS',
    description: 'High-end commercial experience centers tailored to elevate brand heritage, featuring floating display frameworks and client hospitality lounges.',
    features: [
      'Floating Display Frameworks',
      'Bespoke Brand Entryways',
      'Integrated Audio-Visual Design',
      'Client Hospitality Lounges'
    ],
    cycle: '8-12 Weeks'
  },
  {
    id: 'home',
    label: 'HOME',
    tag: 'ATELIER BEDROOM 4',
    chapter: '04',
    image: '/images/slide-bedroom.png',
    concept: 'NOCTURNAL SANCTUARY',
    title: 'INTIMATE MASTER RETREAT SUITES',
    description: 'Moody master sanctuaries designed for absolute isolation, featuring custom velvet bed headboards and low-glow illumination.',
    features: [
      'Velvet Accented Wall Paneling',
      'Automated Twilight Dimming Controls',
      'Bespoke Bedstead Engineering',
      'Luxury En-Suite Bathroom Integration'
    ],
    cycle: '5-6 Weeks'
  }
];
...
export default function CuratedAtelier({ 
  ...
  return (
    <section ref={sectionRef} className="relative z-30 bg-[#fbf9f6] text-luxury-charcoal py-24 px-6 md:px-16 lg:px-24 border-t border-black/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 reveal-3d-popup">
          ...
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-light text-[#1a1a1a] tracking-tight">
            Curated Architectural <span className="italic font-normal text-[#710014]">Services</span>
          </h2>

          <p className="font-sans text-xs md:text-sm text-luxury-charcoal/70 leading-relaxed font-light max-w-2xl mx-auto">
            We design environments that harmonize rustic organic textures with the precision of polished gold fittings. Experience custom craftsmanship tailored to your daily routines.
          </p>
        </div>
        ...
        <div className="bg-white border border-black/10 rounded-none overflow-hidden shadow-[0_25px_70px_rgba(0,0,0,0.05)] grid grid-cols-1 lg:grid-cols-12 items-stretch reveal-3d-popup delay-100 relative">
              ...
              {localAtelierServices.map((tab, idx) => (
                ...
                >
                  <img 
                    src={tab.image} 
                    alt={tab.title}
                    className="w-full h-full object-cover opacity-85 transition-transform duration-[1200ms] ease-out hover:scale-105"
                  />
          ...
          <div className="lg:col-span-7 p-5 md:p-10 lg:p-12 flex flex-col justify-between space-y-8 lg:space-y-10">
            ...
            <div className="flex items-center gap-2 pb-4 lg:pb-6 border-b border-black/5 overflow-x-auto scrollbar-none whitespace-nowrap flex-nowrap -mx-2 px-2">
              {localAtelierServices.map((tab, idx) => (
                <button
                  ...
                  className={`px-4.5 py-2 rounded-none font-sans text-[9px] lg:text-[10px] font-bold tracking-widest uppercase transition-all duration-300 flex-shrink-0 ${
                    idx === activeTabIdx 
            ...
            {/* Content Panel */}
            <div className="space-y-5 lg:space-y-6 flex-grow flex flex-col justify-center">
              ...
              <p className="font-sans text-[11px] lg:text-sm text-luxury-charcoal/70 leading-relaxed font-light">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 pt-2">
                {localAtelierServices[activeTabIdx].features.map((feature, fIdx) => (
                  <div key={fIdx} className="flex items-center gap-2.5">
                    <div className="w-4.5 h-4.5 rounded-full bg-luxury-sage/10 flex items-center justify-center flex-shrink-0">
                      <svg className="w-3 h-3 text-luxury-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
              ...
              <div className="pt-4 lg:pt-6">
                <div className="inline-flex items-center gap-2.5 bg-[#fbf9f6] border border-luxury-charcoal/5 px-3.5 py-2 rounded-lg max-w-full">
                  <span className="font-sans text-[9px] lg:text-[10px] text-luxury-charcoal/50 font-medium">
                    Estimated Cycle:
                  </span>
                  <span className="font-sans text-[9px] lg:text-[10px] font-bold text-luxury-charcoal uppercase bg-luxury-sage/15 text-luxury-sage px-2 py-0.5 rounded">
                    {localAtelierServices[activeTabIdx].cycle}
                  </span>
                </div>
              </div>
            ...
            {/* Bottom Controls Bar */}
            <div className="flex items-center justify-between pt-5 lg:pt-6 border-t border-luxury-charcoal/5 gap-4">
              ...
              >
                <span className="relative z-10 flex items-center gap-1.5">
                  <span className="hidden sm:inline">Detailed Specifications</span>
                  <span className="sm:hidden">Detailed Specs</span>
