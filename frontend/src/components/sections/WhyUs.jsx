export default function WhyUs({ 
  ...
  return (
    <div 
      ref={whyUsRef}
      id="why-us" 
      className="relative w-full h-[300vh] bg-luxury-cream z-30 shadow-[0_-20px_50px_rgba(22,22,22,0.05)]"
    >
      {/* Pinned Viewport Container */}
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center bg-luxury-cream text-luxury-charcoal">
        
        {/* Rising Background Curtain */}
        <div 
          className="absolute inset-0 bg-luxury-cream z-0"
          style={{
            transform: `translateY(${(1 - whyUsBgProgress) * 100}vh)`,
        ...
        <div 
          className="absolute font-display text-[22vw] text-luxury-charcoal/[0.015] font-extralight select-none pointer-events-none z-0"
          style={{
            left: '5%',
            top: '30%',
            transform: `translateY(${(whyUsBgProgress - 0.5) * -80}px)`,
            willChange: 'transform'
          }}
        >
          ATELIER
        ...
        <div className="max-w-7xl mx-auto w-full px-6 md:px-16 lg:px-24 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 xl:gap-8 items-start">
            
            {/* LEFT COLUMN: Header & Card 1 */}
            <div className="lg:col-span-5 space-y-6 lg:space-y-8">
              
              {/* Header (Fades and floats dynamically on scroll) */}
              <div 
                className="space-y-3 lg:space-y-4"
                style={{
                  ...getWhyUsRevealStyle(0.0, 0.30),
                  transform: `${getWhyUsRevealStyle(0.0, 0.30).transform || ''} translateY(${(whyUsBgProgress - 0.5) * -25}px)`
                }}
              >
              ...
              {/* Card 1: Signature Finish - Desktop only */}
              {isDesktop && (
                <div 
                  style={getWhyUsRevealStyle(0.15, 0.35)}
            ...
            <div className={isDesktop ? "lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-5 xl:gap-6 self-center" : "relative w-full h-[360px] md:h-[280px] mt-6"}>
              
              {/* Card 1: Mobile overlay only */}
              {!isDesktop && (
                <div 
                  style={getWhyUsRevealStyle(0.10, 0.15)}
                  className="bg-luxury-charcoal text-luxury-cream border border-luxury-cream/[0.03] p-5 rounded-2xl flex flex-col justify-between space-y-6 cursor-pointer shadow-[0_15px_35px_-15px_rgba(22,22,22,0.4)]"
                >
                  <div>
                    <div className="flex items-center justify-between">
                    ...
                    <p className="font-sans text-[11px] text-luxury-cream/70 leading-relaxed font-light mt-2">
                      We custom-engineer all cabinet doors with solid marine plywood, laminated in high-grade natural timber veneers. Accented by hand-selected solid brass handles and rust-resistant premium mechanisms.
                    </p>
                  </div>
                </div>
              ...
              {/* Card 2: Showrooms */}
              <div 
                style={getWhyUsRevealStyle(0.28, 0.15)}
              ...
              <div 
                style={getWhyUsRevealStyle(0.46, 0.15)}
              ...
              {/* Card 4: Timeline */}
              <div 
                style={getWhyUsRevealStyle(0.64, 0.15)}
                className="bg-white text-luxury-charcoal border border-luxury-charcoal/5 p-5 rounded-2xl flex flex-col justify-between space-y-5 cursor-pointer group hover:bg-white hover:border-luxury-sage/20 hover:-translate-y-1 transition-all duration-500 ease-out shadow-[0_15px_35px_-15px_rgba(22,22,22,0.03)] hover:shadow-[0_20px_40px_-15px_rgba(22,22,22,0.08)]"
              >
                <div>
                  <div className="flex items-center justify-between">
              ...
              {/* Card 5: Credentials */}
              <div 
                style={getWhyUsRevealStyle(0.82, 0.15)}
